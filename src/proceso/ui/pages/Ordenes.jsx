...
import { traducirError, badgeDe, estadoConciliacion, temporadaParaCrear, plantaParaMutar } from "../../core/procesoF7Domain";
import {
  ...
  const crear = async () => {
    ...
    try {
      ...
      const o = await crearOrden({
        empresa_id: empresa, folio, planta_id: pg.planta, estado: "en_proceso",
