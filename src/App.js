...
function OsirisLogoSmall() {
  return (
    <svg height="38" viewBox="0 0 420 160" style={{display:"block"}} role="img" aria-label="Osiris Plant Management">
      <text x="0" y="118" fontFamily="Arial,sans-serif" fontWeight="900" fontSize="112" fill="#fff" letterSpacing="-3" opacity="0.95">OSIRIS</text>
      <text x="4" y="150" fontFamily="Arial,sans-serif" fontWeight="400" fontSize="21" fill="rgba(255,255,255,0.7)" letterSpacing="5">PLANT MANAGEMENT</text>
      <line x1="375" y1="14"  x2="412" y2="36"  stroke="rgba(255,255,255,0.7)" strokeWidth="3" strokeLinecap="round"/>
      <line x1="412" y1="36"  x2="412" y2="82"  stroke="rgba(255,255,255,0.7)" strokeWidth="3" strokeLinecap="round"/>
      <line x1="412" y1="82"  x2="375" y2="104" stroke="rgba(255,255,255,0.7)" strokeWidth="3" strokeLinecap="round"/>
      <line x1="375" y1="104" x2="338" y2="82"  stroke="rgba(255,255,255,0.7)" strokeWidth="3" strokeLinecap="round"/>
      <line x1="338" y1="82"  x2="338" y2="36"  stroke="rgba(255,255,255,0.7)" strokeWidth="3" strokeLinecap="round"/>
