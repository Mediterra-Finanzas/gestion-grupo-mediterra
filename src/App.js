...
export default function OsirisModule({usuarioActual,esAdmin,esSoloConsulta,osirisData,setOsirisData}) {
  ...
  return (
    <div>
      {/* Header */}
      <div style={{background:"linear-gradient(135deg,#0f2d4a,#0f766e)",borderRadius:14,padding:"16px 22px",marginBottom:18,color:"#fff",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:10}}>
        <div>
          ...
          <div style={{fontSize:12,opacity:0.75,marginTop:2}}>Gestión de Ingresos y Cobros</div>
        </div>
        <div style={{textAlign:"right"}}>
          <div style={{fontSize:11,opacity:0.7,marginBottom:2}}>Total pendiente de cobro</div>
          <div style={{fontSize:22,fontWeight:800,color:"#fbbf24"}}>{$$(totPend)}</div>
        </div>
      </div>
