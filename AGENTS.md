# AGENTS.md — Gestión Grupo Mediterra

Aplicación web interna para la gestión financiera y operativa de **Grupo Mediterra**, un grupo agrícola chileno con 8 empresas. Este archivo es el contexto principal del proyecto para Codex.
...
- `mediterra-context` — contexto financiero/operativo profundo del grupo (Codex.ai)
- `cfo-board-reporting` — preparar informes directorio, KPIs IFRS (Codex.ai)
- `humanizer` — limpieza de outputs AI-generated en comunicaciones (Codex.ai)

(Estos skills están en Codex.ai; en Codex no se invocan así, pero el conocimiento que contienen está descrito acá)
