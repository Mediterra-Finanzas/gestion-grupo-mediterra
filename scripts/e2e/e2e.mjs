...
await pCli.locator('input[inputmode=decimal]').first().fill('0.1');
await pCli.locator('input[inputmode=decimal]').first().evaluate(e => e.blur());
...
await pProd.locator('input[inputmode=decimal]').first().fill('0.1');
await pProd.locator('input[inputmode=decimal]').first().evaluate(e => e.blur());
...
await pCli3.locator('input[inputmode=decimal]').nth(1).fill('0.05');
await pCli3.locator('input[inputmode=decimal]').nth(1).evaluate(e => e.blur());
